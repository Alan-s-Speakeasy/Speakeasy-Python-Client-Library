...
class ChatRoomState(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, info, messages, reactions, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, info, messages, reactions, *args, **kwargs):  # noqa: E501
        """ChatRoomState - a model defined in OpenAPI
